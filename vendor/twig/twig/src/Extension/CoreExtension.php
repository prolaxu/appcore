...
final class AppCoreExtension extends AbstractExtension
{
...
namespace {
    ...
    use Twig\Extension\AppCoreExtension;
...
{
    if (null === $format) {
        $formats = $env->getExtension(AppCoreExtension::class)->getDateFormat();
...
function twig_date_converter(Environment $env, $date = null, $timezone = null)
{
    ...
    if (false !== $timezone) {
        if (null === $timezone) {
            $timezone = $env->getExtension(AppCoreExtension::class)->getTimezone();
    ...
    if (null === $date || 'now' === $date) {
        ...
        return new \DateTime($date, false !== $timezone ? $timezone : $env->getExtension(AppCoreExtension::class)->getTimezone());
    }
    ...
    if (ctype_digit($asString) || (!empty($asString) && '-' === $asString[0] && ctype_digit(substr($asString, 1)))) {
        ...
        $date = new \DateTime($date, $env->getExtension(AppCoreExtension::class)->getTimezone());
    }
...
{
    $defaults = $env->getExtension(AppCoreExtension::class)->getNumberFormat();
    if (null === $decimal) {
        $decimal = $defaults[0];
    }
